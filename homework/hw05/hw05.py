class VendingMachine:
    ...
    def vend(self):
        if self.stock_amount == 0:
            ...
            if self.funds < self.price:
                print('\'You must add ${} more funds.\''.format(self.price - self.funds))
            elif self.funds == self.price:
                print('\'Here is your {}.\''.format(self.product))
                self.funds = 0
                self.stock_amount -= 1
            else:
                print('\'Here is your {0} and ${1} change.\''.format(self.product, self.funds - self.price))
                self.funds = 0
                self.stock_amount -= 1
    ...
    def add_funds(self, fund):
        if self.stock_amount == 0:
            print('\'Inventory empty. Restocking required. Here is your ${}.\''.format(fund))
        else:
            self.funds += fund
    ...
    def restock(self, amount):
        ...
        print('\'Current {0} stock: {1}\''.format(self.product, self.stock_amount))
...
def store_digits(n):
    ...
    if n < 10:
        ...
        while cur >= 10:
            cur //= 10
            digit *= 10
        return Link(cur, store_digits(n % digit))
